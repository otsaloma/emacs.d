...
(custom-theme-set-faces
 ...
 `(default ((t (:background "#fff1e5" :foreground "#444444"))))
 `(fringe ((t (:foreground "#1d77ff"))))
 `(header-line ((t (:background "#fff1e5" :box (:line-width 12 :color "#fff1e5")))))
 ...
 `(mode-line ((t (:background "#fff1e5" :foreground "#999999" :box (:line-width 6 :color "#fff1e5")))))
 `(mode-line-inactive ((t (:background "#fff1e5" :foreground "#cccccc" :box (:line-width 6 :color "#fff1e5")))))
 ...
 `(vertical-border ((t (:foreground "#fff1e5"))))
 ...
 `(company-tooltip-selection ((t (:background "#527bcc" :foreground "#fff1e5"))))
 ...
 `(git-gutter:added ((t (:background "#88ff88" :foreground "#fff1e5"))))
 `(git-gutter:deleted ((t (:background "#ff8888" :foreground "#fff1e5"))))
 `(git-gutter:modified ((t (:background "#8888ff" :foreground "#fff1e5"))))
 ...
 `(tabbar-default ((t (:background "#fff1e5" :foreground "#999999"))))
 `(tabbar-selected ((t (:background "#fff1e5" :foreground "#111111"))))
