...
(custom-theme-set-faces
 ...
 `(default ((t (:background "#f2f2f2" :foreground "#444444"))))
 ...
 `(mode-line ((t (:background "#f2f2f2" :foreground "#999999" :box (:line-width 6 :color "#f2f2f2")))))
 `(mode-line-inactive ((t (:background "#f2f2f2" :foreground "#cccccc" :box (:line-width 6 :color "#f2f2f2")))))
 ...
 `(vertical-border ((t (:foreground "#f2f2f2"))))
 ...
 `(git-gutter:added ((t (:background "#88ff88" :foreground "#f2f2f2"))))
 `(git-gutter:deleted ((t (:background "#ff8888" :foreground "#f2f2f2"))))
 `(git-gutter:modified ((t (:background "#8888ff" :foreground "#f2f2f2"))))
 `(jinx-misspelled ((t (:underline "#b0a678"))))
 `(makefile-shell ((t (:background unspecified :foreground unspecified))))
 ...
 `(tab-line ((t (:background "#f2f2f2" :box (:line-width (1 . 10) :color "#f2f2f2")))))
