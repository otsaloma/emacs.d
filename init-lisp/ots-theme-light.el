...
(custom-theme-set-faces
 ...
 `(default ((t (:background "#ffffff" :foreground "#444444"))))
 ...
 `(linum ((t (:background nil :foreground "#bbbbbb" :underline nil :box nil))))
 ...
 `(neo-file-link-face ((t (:background nil :foreground "#303030"))))
 `(neo-root-dir-face ((t (:background nil :foreground "#303030"))))
 ...
 `(tabbar-selected ((t (:background "#f6f5f4" :foreground "#303030" :box (:line-width 12 :color "#f6f5f4")))))
