...
(custom-theme-set-faces
 ...
 `(font-lock-comment-face ((t (:background "#f0f5fa" :foreground "#84a3c2"))))
 ...
 `(tabbar-default ((t (:background "#fafafa" :foreground "#999999"))))
 `(tabbar-selected ((t (:background "#fafafa" :foreground "#111111"))))
