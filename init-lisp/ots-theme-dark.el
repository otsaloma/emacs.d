...
(custom-theme-set-faces
 ...
 `(default ((t (:background "#303030" :foreground "#bbbbbb"))))
 `(fringe ((t (:foreground "#bbbbbb"))))
 `(header-line ((t (:background "#353535"))))
 `(highlight ((t (:underline t))))
 `(isearch ((t (:background "#ffcc00" :foreground "#303030"))))
 `(lazy-highlight ((t (:background "#cccccc" :foreground "#303030"))))
 ...
 `(mode-line ((t (:background "#444444" :foreground "#999999" :box (:line-width 6 :color "#444444")))))
 `(mode-line-inactive ((t (:background "#444444" :foreground "#666666" :box (:line-width 6 :color "#444444")))))
 `(query-replace ((t (:background "#ffcc00" :foreground "#303030"))))
 `(region ((t (:background "#527bcc" :foreground "#ffffff"))))
 `(show-paren-match ((t (:background nil :foreground "#90b078"))))
 `(show-paren-mismatch ((t (:background nil :foreground "#e68a8a"))))
 ...
 `(linum ((t (:background nil :foreground "#555555" :underline nil :box nil))))
 ...
 `(neo-file-link-face ((t (:background nil :foreground "#cccccc"))))
 `(neo-root-dir-face ((t (:background nil :foreground "#cccccc"))))
 `(popup-tip-face ((t (:background "#eeeeee" :foreground "#303030"))))
 `(sh-heredoc ((t (:foreground "#b294bb"))))
 `(tabbar-default ((t (:background "#444444" :foreground "#999999" :box (:line-width 12 :color "#444444")))))
 `(tabbar-selected ((t (:background "#353535" :foreground "#bbbbbb" :box (:line-width 12 :color "#353535")))))
