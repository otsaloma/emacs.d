...
(custom-theme-set-faces
 ...
 `(header-line ((t (:background "#313131"))))
 ...
 `(corfu-default ((t (:background "#666666" :foreground "#dddddd"))))
 ...
 `(markdown-inline-code-face ((t (:background unspecified :foreground "#b294bb"))))
 ...
 `(tab-line ((t (:background "#313131" :box (:line-width (1 . 10) :color "#313131")))))
 `(tab-line-tab ((t (:inherit tab-line))))
 `(tab-line-tab-current ((t (:inherit tab-line :foreground "#eeeeee"))))
 `(tab-line-tab-inactive ((t (:inherit tab-line :foreground "#888888"))))
 `(tab-line-tab-modified ((t (:foreground "#e68a8a"))))
 `(tab-line-highlight ((t (:inherit tab-line-tab-current))))
 `(vertico-current ((t (:background "#375288" :foreground unspecified))))
 `(vertico-group-title ((t (:foreground "#d1d175"))))
