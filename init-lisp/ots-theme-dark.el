...
(custom-theme-set-faces
 ...
 `(line-number ((t (:foreground "#6e706b" :height 0.85))))
 `(line-number-current ((t (:foreground "#babdb6" :height 0.85))))
 ...
 `(linum ((t (:background "#33393b" :foreground "#6e706b" :height 0.85 :underline nil :box nil))))
 ...
 `(neo-root-dir-face ((t (:background nil :foreground "#babdb6"))))
 `(popup-tip-face ((t (:background "#d3d7cf" :foreground "#2e3436"))))
 `(sh-heredoc ((t (:foreground "#b294bb"))))
 `(tabbar-default ((t (:background "#33393b" :foreground "#6e706b" :box (:line-width 12 :color "#33393b")))))
 `(tabbar-selected ((t (:background "#2e3436" :foreground "#babdb6" :box (:line-width 12 :color "#2e3436") :overline "#434746"))))
