...
(custom-theme-set-faces
 ...
 `(default ((t (:background "#242424" :foreground "#aaaaaa"))))
 `(fringe ((t (:foreground "#aaaaaa"))))
 `(header-line ((t (:background "#242424" :box (:line-width 24 :color "#242424")))))
 `(highlight ((t (:underline t))))
 `(isearch ((t (:background "#ffcc00" :foreground "#242424"))))
 ...
 `(query-replace ((t (:background "#ffcc00" :foreground "#242424"))))
 ...
 `(company-tooltip ((t (:background "#eeeeee" :foreground "#242424"))))
 ...
 `(git-gutter:added ((t (:background "#88ff88" :foreground "#242424"))))
 `(git-gutter:deleted ((t (:background "#ff8888" :foreground "#242424"))))
 `(git-gutter:modified ((t (:background "#8888ff" :foreground "#242424"))))
 ...
 `(popup-tip-face ((t (:background "#eeeeee" :foreground "#242424"))))
 `(sh-heredoc ((t (:foreground "#b294bb"))))
 `(sh-quoted-exec ((t (:foreground "#e68a8a"))))
 `(tab-line ((t :background "#353535")))
 `(tabbar-default ((t (:background "#242424" :foreground "#888888"))))
 `(tabbar-selected ((t (:background "#242424" :foreground "#eeeeee"))))
 ...
 `(vterm-color-black ((t (:foreground "#242424"))))
